...
const Profile = () => {
    ...
    const handleChangePassword = async () => {
        ...
        if (!passwordValidation.isValid) {
            setStatusPopup({ show: true, type: 'error', message: passwordValidation.errors.join('. ') });
            return;
        }
        ...
        try {
            ...
            setStatusPopup({ show: true, type: 'error', message: "Failed to update password: " + (error.response?.data?.msg || error.message) });
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            const updatedProfile = await updateProfileAPI({
                ...
                mobile: editMobile !== user.mobile ? editMobile : undefined
            });
    ...
    const handleImageUpload = async (e) => {
        ...
        try {
            ...
            dispatch(setUser({ ...user, photoURL: data.url }));
