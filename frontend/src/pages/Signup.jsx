...
import { registerAPI, checkUsernameAPI, loginAPI } from '../services/api';
...
const Signup = () => {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            const usernameCheck = await checkUsernameAPI(username);
            ...
            console.log("3. Creating user via custom backend...");
            ...
            if (!registerData.user) throw new Error("No user created");

            console.log("4. Auto-logging in user to get token...");
        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
            ...
            {loading ? (
                ...
                >
                    ...
                    <h2 className="text-2xl font-bold text-primary animate-pulse">Creating Account...</h2>
                ...
                >
                    <h2 className="text-3xl font-bold text-primary mb-2 text-center">Join Vortix</h2>
                    <p className="text-text-muted text-center mb-8">Create your account to start tracking.</p>
