                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        <div className="relative flex-1 md:flex-none">
                            <button
                                ...
                                className={`w-full md:w-auto border ${comparisonCoin ? 'border-primary text-primary' : 'border-gray-800 text-gray-400'} hover:border-gray-600 hover:text-white font-medium py-1.5 px-4 rounded transition-colors flex items-center justify-center gap-2 text-sm whitespace-nowrap cursor-pointer bg-transparent`}
                            >
