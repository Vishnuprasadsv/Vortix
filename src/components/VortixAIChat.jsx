  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-24 left-4 right-4 md:left-auto md:right-6 z-100 md:w-96 h-[70vh] md:h-150 bg-[#0F0F0F] rounded-2xl border border-orange-500/50 shadow-[0_0_20px_rgba(255,95,31,0.3)] flex flex-col overflow-hidden backdrop-blur-md"
      >
