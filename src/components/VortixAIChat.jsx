...
const VortixAIChat = ({ isOpen, onClose }) => {
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hello! I'm VortixAI. Ask me anything about crypto or your portfolio!",
      sender: "ai",
    },
  ]);
  ...
  const handleSend = async (text = input) => {
    ...
    try {
      ...
      const errorMsg = {
        ...
        text:
          error.message ||
          "Sorry, I encountered an error connecting to the AI neural network. Please check your connection or API key.",
        sender: "ai",
        isError: true,
      };
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-24 left-4 right-4 md:left-auto md:right-6 z-[100] md:w-96 h-[70vh] md:h-[600px] bg-[#0F0F0F] rounded-2xl border border-orange-500/50 shadow-[0_0_20px_rgba(255,95,31,0.3)] flex flex-col overflow-hidden backdrop-blur-md"
      >
        <div className="p-4 bg-gradient-to-r from-orange-600/20 to-transparent border-b border-orange-500/30 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-white text-lg tracking-wide drop-shadow-[0_0_5px_rgba(255,95,31,0.5)]">
                VortixAI
              </h3>
          ...
          {isLoading && (
            <div className="flex justify-start">
              <div className="bg-[#1E1E1E] p-4 rounded-2xl rounded-tl-none border border-gray-800 flex gap-2 items-center">
                <div
                  className="w-2 h-2 bg-orange-500/50 rounded-full animate-bounce"
        ...
        {messages.length === 1 && (
          <div className="px-4 pb-2">
            <p className="text-xs text-gray-500 mb-2 flex items-center gap-1">
              <FaLightbulb className="text-yellow-500" /> Suggested Questions
            </p>
