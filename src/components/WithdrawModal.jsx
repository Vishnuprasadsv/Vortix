              ...
              <div className="text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-yellow-500/80 text-xs bg-yellow-500/10 p-2 rounded border border-yellow-500/20">
                    Note: Payment will take 3 bank working days to get it in the
                    account.
                  </p>
                </div>
                ...
                <div className="flex bg-[#0F1114] p-1 rounded-lg border border-gray-800">
                  <button
                    ...
                    className={`flex-1 py-2 rounded-md text-sm font-bold flex items-center justify-center gap-2 transition-all ${
                      paymentMethod === "bank"
                        ? "bg-[#1E2329] text-white shadow-sm border border-gray-700"
                  ...
                  {paymentMethod === "bank" ? (
                    <>
                      <div>
                        ...
                        <input
                          type="text"
                          className="w-full bg-[#0F1114] border border-gray-800 rounded px-3 py-2 text-white focus:border-gray-600 outline-none"
              ...
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Please enter your account password to confirm this
                    withdrawal of{" "}
                    <span className="text-white font-bold">
                      ${Number(amount).toLocaleString()}
                    </span>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full bg-[#0F1114] border ${
                      passwordError ? "border-red-500" : "border-gray-700"
                    } rounded-lg py-4 px-4 text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition-colors`}
                    placeholder="••••••••"
                  />
                  {passwordError && (
              ...
              <div className="text-center space-y-6 py-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 bg-gray-800/50 p-3 rounded-lg border border-gray-700">
                    ...
                    to get the amount in your account.
                  </p>
                </div>
                <button
                  onClick={onClose}
