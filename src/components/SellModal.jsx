...
const getIcon = (symbol, color) => {
    switch (symbol) {
        ...
        default: return <div className="font-bold text-2xl" style={{ color: color }}>{symbol?.charAt(0)}</div>;
    }
}
                    ...
                    <div className="p-6 pt-2 space-y-6">
                        <div className="bg-[#16191E] border border-gray-800 rounded-xl p-4 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="text-gray-500 text-sm">${currentPrice.toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
                            </div>
                        </div>

                        <div className="space-y-1">
                            <label className="text-sm text-gray-400">Amount ({asset.symbol})</label>
                        ...
                        >
                            {loading ? 'Selling...' : <>Sell Now <ExternalLink size={16} className="group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" /></>}
                        </Button>
                    </div>
                </motion.div>
            </div>
